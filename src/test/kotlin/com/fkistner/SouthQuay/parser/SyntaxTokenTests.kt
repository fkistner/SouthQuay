...
import com.fkistner.SouthQuay.UI.SyntaxTokenMaker
...
class SyntaxTokenTests {
    ...
    fun tokenTranslation() {
        ...
        var tokenList: Token? = SyntaxTokenMaker.getTokenList(text, 0, 33)
    ...
    fun tokenTranslationSliceCharArray() {
        ...
        var tokenList: Token? = SyntaxTokenMaker.getTokenList(text, 0, 11)
        Assert.assertEquals(charArray, tokenList!!.textArray)
