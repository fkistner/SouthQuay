...
class Dialogs(val frame: JFrame) {
     ...
     * @return The path to the selected file or `null`
     */
    ...
    /**
     * Presents the given file dialog, filters for script files, and translates the selected file to a Path object.
     * @return The path to the selected file or `null`
     */
    private fun present(fileDialog: FileDialog): Path? {
